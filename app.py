...
st.markdown("""
<style>
    /* 📝 JUSTIFIER LE TEXTE ET CIBLER UNIQUEMENT LES PARAGRAPHES/LISTES */
    .stMarkdown p, .stMarkdown li {
        text-align: justify;
        font-size: 18px !important;
    }
    
    /* 💻 RÉGLAGES DES MÉTRIQUES PAR DÉFAUT */
...
# -----------------------------------------------------
    ...
    * **Ce que dit la réglementation :** Une directive européenne de 2006 impose aux autorités sanitaires de surveiller deux FIB (Fecal Indicator Bacteria / bactéries indicatrices de pollution fécale) : Escherichia coli (E. coli) et les entérocoques intestinaux. 
    ...
    * **Attention au milieu urbain !** Une fuite de canalisation d'égout peut libérer énormément de bactéries sans amener de sédiments. L'eau reste alors très claire mais devient extrêmement contaminée. 
    * A l’inverse, des cours d’eau peuvent être turbides sans pour autant présenter un risque sanitaire (exemple : turbidité de l’eau liée à la fonte de glacier, etc…) ; le contexte géographique et saisonnier est donc essentiel à prendre en compte.
